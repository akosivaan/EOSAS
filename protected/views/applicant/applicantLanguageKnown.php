...
<?php
/* @var $this ApplicantlanguageknownController */
/* @var $model ApplicantLanguageKnown */
...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'applicant-language-known-applicantlanguageknown-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'known'); ?>
		<?php echo $form->textField($model,'known',array('id'=>'known', 'onChange'=> 'validateName(id);')); ?>
		<?php echo $form->error($model,'known'); ?>
	</div>
