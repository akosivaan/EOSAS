...
<?php $form=$this->beginWidget('CActiveForm', array(
  ...
  <tr>
    <td>
	<?php 
    echo CHtml::checkBoxList('people','mutiple',
      array(
        'Teaching'=>'Teaching',
  ...
  ?>
    ...
    <td>
  <?php 
    echo CHtml::checkBoxList('data','mutiple',
      array(
  ...
  ?>
    ...
    <td>
  <?php 
    echo CHtml::checkBoxList('thing','mutiple',
      array(
  ...
  ?>
    ...
    <td>
  <?php 
    echo CHtml::checkBoxList('idea','mutiple',
      array(
  ...
  <input type='hidden' value='val' name='skillSet'/>
